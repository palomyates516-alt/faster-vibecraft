...
### 使用原版：
```bash
# nearcyan 的原始 vibecraft
npx vibecraft setup
npx vibecraft
```

打开 http://localhost:4003 并正常使用 Claude Code。你会看到 Claude 在工作坊中移动并使用各种工具。
...
原始仓库：https://github.com/nearcyan/vibecraft
此分支：https://github.com/palomyates516-alt/faster-vibecraft
